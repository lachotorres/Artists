...
namespace Artists.Controllers
{
    public class GigsController : Controller
    {
        ...
        /// <returns></returns>
        /// <remarks>
        /// return type changed to VireResult due integration test
        /// </remarks>
        [Authorize]
        ...
        public ActionResult Create(GigFormViewModel viewModel)
        {
            ...
            {
                //en este punto viewModelse inicializa con los valored del hpptRequest y Genres esta vacio, hay que popularlo
